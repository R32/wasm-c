...
@:build(Nvd.build("../index.html", "#player", {
	...
	// TODO: The following should be auto generated by macros
	var btngroup(get, never) : BtnGroupUi;
	var progress(get, never) : ProgressUi;
	var fileopen(get, never) : FileOpenUi;

	private inline function get_btngroup() : BtnGroupUi return cast _btngroup;
	private inline function get_progress() : ProgressUi return cast _progress;
	private inline function get_fileopen() : FileOpenUi return cast _fileopen;
}
